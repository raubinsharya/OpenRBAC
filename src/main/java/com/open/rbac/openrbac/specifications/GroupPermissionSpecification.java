...
public class GroupPermissionSpecification {
    ...
    public static Specification<GroupPermission> ofGroup(Long groupId, Collection<Long> ancestorIds, Integer groupLevel,
            Long realmId) {
        return (root, query, cb) -> {
            ...
            if (query != null && GroupPermission.class.equals(query.getResultType())) {
    ...
    public static Specification<GroupPermission> hasPermissionName(String name) {
        return (root, query, cb) -> {
    ...
    public static Specification<GroupPermission> hasPermissionStatus(EntityStatus status) {
        return (root, query, cb) -> {
            if (status == null)
                return null;
    ...
    public static Specification<GroupPermission> hasGroupStatus(EntityStatus status) {
        return (root, query, cb) -> {
            if (status == null)
                return null;
    ...
    public static Specification<GroupPermission> assignedBy(String assignedBy) {
        return (root, query, cb) -> {
    ...
    public static Specification<GroupPermission> isActive(Boolean isActive) {
        return (root, query, cb) -> {
            if (isActive == null)
                return null;
    ...
    public static Specification<GroupPermission> isInherited(Long requestedGroupId, Boolean isInherited) {
        return (root, query, cb) -> {
    ...
    public static Specification<GroupPermission> assignedAtBefore(LocalDateTime date) {
        return (root, query, cb) -> {
            if (date == null)
                return null;
    ...
    public static Specification<GroupPermission> assignedAtAfter(LocalDateTime date) {
        return (root, query, cb) -> {
            if (date == null)
                return null;
    ...
    public static Specification<GroupPermission> expiryDateBefore(LocalDateTime date) {
        return (root, query, cb) -> {
            if (date == null)
                return null;
    ...
    public static Specification<GroupPermission> expiryDateAfter(LocalDateTime date) {
        return (root, query, cb) -> {
            if (date == null)
                return null;
    ...
    public static Specification<GroupPermission> isNotExpired() {
        return (root, query, cb) -> {
            return cb.or(
    ...
    public static Specification<GroupPermission> hasPermissionId(Long permissionId) {
        return (root, query, cb) -> {
            if (permissionId == null)
                return null;
            return cb.equal(root.get("permission").get("id"), permissionId);
        };
    }
}
